...
class TestIssues(QuantityTestCase):
    ...
    def test_issue1144_1102(self):
        ...
        # Issue 1144
        q1 = ureg.Quantity([-287.78, -32.24, -1.94], "delta_degree_Celsius")
        q2 = ureg.Quantity(70.0, "degree_Fahrenheit")
        q3 = q1 - q2
        assert all(q1 == ureg.Quantity([-287.78, -32.24, -1.94], "delta_degree_Celsius"))
        assert q2 == ureg.Quantity(70.0, "degree_Fahrenheit")
        q3 = q2 - q1
        assert all(q1 == ureg.Quantity([-287.78, -32.24, -1.94], "delta_degree_Celsius"))
        assert q2 == ureg.Quantity(70.0, "degree_Fahrenheit")
        # Issue 1102
        val = [30., 45., 60.] * ureg.degree
        val == 1
        1 == val
        assert all(val == ([30., 45., 60.] * ureg.degree))
