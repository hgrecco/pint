...
The column headers are the **Original Quantity** being converted; each cell is
the **Formatted Quantity** produced by applying that row's method.
...
.. doctest::
   ...
   Quantity(1000.0, "gram * meter / second ** 2")
...
.. doctest::
   ...
   Quantity(3.6, "meter ** 2 * megagram / second ** 2")
